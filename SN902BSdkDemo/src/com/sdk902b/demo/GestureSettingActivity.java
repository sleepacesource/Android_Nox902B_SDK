...
public class GestureSettingActivity extends BaseActivity {
	...
	public void findView() {
		...
		colorSetting = findViewById(R.id.tv_color_setting);
	...
	public void initListener() {
		...
		colorSetting.setOnClickListener(this);
	...
	public void onClick(View v) {
		...
		case R.id.gesture_control_rl_invalid:
			selectDisable();
			break;
		case R.id.tv_color_setting:
			Intent intent = new Intent(GestureSettingActivity.this, GestureColorSetActivity.class);
