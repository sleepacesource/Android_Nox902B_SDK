...
import com.sdk902b.demo.util.BleDeviceNameUtil;
			...
			runOnUiThread(new Runnable() {
				public void run() {
					...
					if(cd.isSuccess()) {
						...
						mHelper.syncTime(time, 3000, null);
...
//		            SdkLog.log(TAG+" onLeScan deviceName:" + deviceName);
		            ...
		            if(!TextUtils.isEmpty(modelName) && !TextUtils.isEmpty(deviceName) && deviceName.startsWith("SN21") && deviceName.length() == 13){
